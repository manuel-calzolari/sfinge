...
<form method="post">
  <fieldset>
    <input type="hidden" name="referer" value="update_text"> <input type="hidden" name="question_type" value="text">
    <div class="clearfix">
    ...
    <div class="clearfix">
      ...
      <div class="input">
        <textarea class="error" id="errorInput" cols="20" name="instructions" rows="5">${question.instructions}</textarea>
      </div>
      <br>
    </div>
    <div class="clearfix">
